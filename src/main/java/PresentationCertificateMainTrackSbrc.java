...
public class PresentationCertificateMainTrackSbrc {
    private static final String PAPER_SPREADSHEET_ID = "1LmRM_ZlLy9qPq0xIkAvzK5w5Vfsgof2nJF9K4-w9CMA";
    private static final String AUTHOR_SPREADSHEET_ID = "1zHRH-fsILqlF3nWwdF-L2lsPf88Cq_MeKpbtQp4A4oQ";
    private static final String PAPER_SHEET_RANGE = "Artigos!A2:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A2:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-tp-sbrc2025.pdf";
    ...
    private static final String OUTPUT = "certificado-tp-sbrc2025";
    private static final float FONT_SIZE = 15;
    private static final float POSITION_Y = 345;
    private static final float POSITION_Y2 = 265;
    ...
    public static void main(String[] args) {
        ...
        List<Paper> papersMainTrack = importerPapersAuthors.loadPapersWithAuthors();

        GMailService gmailService = new GMailService(authService);

        for (Paper paper : papersMainTrack) {
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        intitulado "%s" na Trilha Principal do SBRC 2025.<br/>
                        ...
                        <p><em>Flavia Coimbra Delicato e Atslands R. Rocha<br/>
                        Coordenadoras da Trilha Principal do SBRC 2025</em></p>
                    </body>
                </html>
