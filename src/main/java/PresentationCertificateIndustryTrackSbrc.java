...
public class PresentationCertificateIndustryTrackSbrc {
    private static final String PAPER_SPREADSHEET_ID = "1h-68Evi1jJSNu1Ba52HgZF1N-ClWcFN4sTDsqlMTKAU";
    private static final String AUTHOR_SPREADSHEET_ID = "16wH1XDhipAJ2drBq_MnGrtJoaamTpOklgMhUwPkYpkc";
    private static final String PAPER_SHEET_RANGE = "Artigos!A2:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A2:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-ti-sbrc2025.pdf";
    ...
    private static final String OUTPUT = "certificado-ti-sbrc2025";
    private static final float FONT_SIZE = 15;
    private static final float POSITION_PAPER_TITLE = 350;
    private static final float POSITION_AUTHOR_LIST = 265;
    private static final String EMAIL_FROM = "sbrc2025@ufrn.br";
    private static final String EMAIL_SUBJECT = "[SBRC 2025] Certificado de Apresentação";
    ...
    public static void main(String[] args) {
        ...
        List<Paper> papersIndustryTrack = importerPapersAuthors.loadPapersWithAuthors();

        GMailService gmailService = new GMailService(authService);

        for (Paper paper : papersIndustryTrack) {
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        intitulado "%s" na Trilha de Interação com a Indústria e de Inovação do SBRC 2025.<br/>
                        ...
                        <p><em>Paulo de Figueiredo Pires e Michelle Wangham<br/>
                        Coordenadores da Trilha de Interação com a Indústria e de Inovação do SBRC 2025</em></p>
                    </body>
                </html>
