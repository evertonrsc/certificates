...
public class PresentationCertificateWQuNets {
    private static final String PAPER_SPREADSHEET_ID = "1muCj0CSF11l4iKqZNn9zpFRyXFrLaQuGj6ATdZYyGBs";
    private static final String AUTHOR_SPREADSHEET_ID = "1mPAo5ZBD0agXykpx607l79r86KRSsPGO9UmrzGtxxQ8";
    private static final String PAPER_SHEET_RANGE = "Artigos!A3:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A3:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-wqunets2025.pdf";
    ...
    private static final String OUTPUT = "certificado-wqunets2025";
    ...
    private static final String EMAIL_SUBJECT = "[WQuNets 2025] Certificado de Apresentação";
    ...
    public static void main(String[] args) {
        ...
        List<Paper> papersWqunets = importerPapersAuthors.loadPapersWithAuthors();

        GMailService gmailService = new GMailService(authService);

        for (Paper paper : papersWqunets) {
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        intitulado "%s" no WQuNets 2025.<br/>
                        ...
                        <p><em>Antônio Abelém, Diego Abreu, José Ferreira de Rezende e Christian Esteve Rothenberg<br/>
                        Coordenadores do WQuNets 2025</em></p>
                    </body>
                </html>
