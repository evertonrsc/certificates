...
public class PresentationCertificateWPEIF {
    private static final String PAPER_SPREADSHEET_ID = "1YdQ27jcmKIceVYO_nTtTcVdwByqqe73eyMCODLlKZQ0";
    private static final String AUTHOR_SPREADSHEET_ID = "1h21bqz7VIAxmMbKVTFNXXzeWB_2YBxPck3PquCdw1b4";
    private static final String PAPER_SHEET_RANGE = "Artigos!A2:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A2:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-wpeif2025.pdf";
    ...
    private static final String OUTPUT = "certificado-wpeif2025";
    ...
    private static final String EMAIL_SUBJECT = "[WPEIF 2025] Certificado de Apresentação";
    ...
    public static void main(String[] args) {
        ...
        List<Paper> papersWpeif = importerPapersAuthors.loadPapersWithAuthors();

        GMailService gmailService = new GMailService(authService);

        for (Paper paper : papersWpeif) {
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        <p><em>Antônio Abelém, Flavio Silva e José Ferreira de Rezende<br/>
                        Coordenadores do WPEIF 2025</em></p>
                    </body>
                </html>
