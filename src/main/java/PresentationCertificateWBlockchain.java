...
public class PresentationCertificateWBlockchain {
    private static final String PAPER_SPREADSHEET_ID = "1Qp1bR4SawimahliiHUgcbRVeW2Q9qD7XEExJAPbvGXQ";
    private static final String AUTHOR_SPREADSHEET_ID = "18TGOzymR2SEacxMCrGnfZVdrsR-WTeCTnLijrYsfONE";
    private static final String PAPER_SHEET_RANGE = "Artigos!A2:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A2:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-wblockchain2025.pdf";
    ...
    private static final String OUTPUT = "certificado-wblockchain2025";
    ...
    private static final String EMAIL_SUBJECT = "[WBlockchain 2025] Certificado de Apresentação";
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        Coordenadores do WBlockchain 2025</em></p>
                    </body>
                </html>
