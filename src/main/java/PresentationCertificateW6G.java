...
public class PresentationCertificateW6G {
    private static final String PAPER_SPREADSHEET_ID = "19KmpVahUmSX-Zz-ZFSLzIiB3IHbSWSoTT82jKyOTaFg";
    private static final String AUTHOR_SPREADSHEET_ID = "1eFIqi5Mg0kLBVjop_6L0E0kiCdtg7po7MaToIwGQYXo";
    private static final String PAPER_SHEET_RANGE = "Artigos!A2:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A2:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-w6g2025.pdf";
    ...
    private static final String OUTPUT = "certificado-w6g2025";
    ...
    private static final String EMAIL_SUBJECT = "[W6G 2025] Certificado de Apresentação";
    ...
    public static void main(String[] args) {
        ...
        List<Paper> papersW6g = importerPapersAuthors.loadPapersWithAuthors();

        GMailService gmailService = new GMailService(authService);

        for (Paper paper : papersW6g) {
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        <p><em>Antonio Carlos de Oliveira Júnior, Flavio Silva, Luciano Leonel Mendes e Rodrigo Moreira<br/>
                        Coordenadores do W6G 2025</em></p>
                    </body>
                </html>
