...
public class PresentationCertificateToolsSbrc {
    private static final String PAPER_SPREADSHEET_ID = "1RMsgGqSmf7d6r6ay83U-V620v6kHGu2Z8SgVYk824XY";
    private static final String AUTHOR_SPREADSHEET_ID = "1qbyWnMRAsHx_w2xobAf_zJgnUbSeR1xEIBOIr0omvIU";
    private static final String PAPER_SHEET_RANGE = "Artigos!A2:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A2:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-sf-sbrc2025.pdf";
    ...
    private static final String OUTPUT = "certificado-sf-sbrc2025";
    ...
    public static void main(String[] args) {
        ...
        List<Paper> papersTools = importerPapersAuthors.loadPapersWithAuthors();

        GMailService gmailService = new GMailService(authService);

        for (Paper paper : papersTools) {
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        intitulado "%s" no Salão de Ferramentas do SBRC 2025.<br/>
                        ...
                        <p><em>Diego Kreutz e Jó Ueyama<br/>
                        Coordenadoras do Salão de Ferramentas do SBRC 2025</em></p>
                    </body>
                </html>
