...
public class PresentationCertificateWTG {
    private static final String PAPER_SPREADSHEET_ID = "1FnNI3zHDCppdzYksFWOw2Qo_90Uk1KtPE7beQ24pTW0";
    private static final String AUTHOR_SPREADSHEET_ID = "1huRm8KhCw7BEhntZIxv3F6NqUur3x-pBueuqBotSn9Y";
    private static final String PAPER_SHEET_RANGE = "Artigos!A2:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A2:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-wtg2025.pdf";
    ...
    private static final String OUTPUT = "certificado-wtg2025";
    ...
    private static final String EMAIL_SUBJECT = "[WTG 2025] Certificado de Apresentação";
    ...
    public static void main(String[] args) {
        ...
        List<Paper> papersWtg = importerPapersAuthors.loadPapersWithAuthors();

        GMailService gmailService = new GMailService(authService);

        for (Paper paper : papersWtg) {
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        <p><em>Glauber Gonçalves e Helder Oliveira<br/>
                        Coordenadores do WTG 2025</em></p>
                    </body>
                </html>
