...
public class PresentationCertificateWGRS {
    private static final String PAPER_SPREADSHEET_ID = "1cyIt3Lc_kI7rC3R6Gw4uW7BxBhavd-XZGSlSAc7ODrs";
    private static final String AUTHOR_SPREADSHEET_ID = "1y1FjWxogSn9SfrBS58xsFCDqIomcbvQTP8-9LIojeC4";
    private static final String PAPER_SHEET_RANGE = "Artigos!A2:E";
    private static final String AUTHOR_SHEET_RANGE = "Autores!A2:H";
    private static final String TEMPLATE_FILE = "resources/templates/certificado-wgrs2025.pdf";
    ...
    private static final String OUTPUT = "certificado-wgrs2025";
    ...
    private static final String EMAIL_SUBJECT = "[WGRS 2025] Certificado de Apresentação";
    ...
    public static void main(String[] args) {
        ...
        List<Paper> papersWgrs = importerPapersAuthors.loadPapersWithAuthors();

        GMailService gmailService = new GMailService(authService);

        for (Paper paper : papersWgrs) {
            ...
            for (Author author : paper.getAuthors()) {
                ...
                <html>
                    <body>
                        ...
                        <p><em>Leandro Almeida e Joahannes Costa<br/>
                        Coordenadores do WGRS 2025</em></p>
                    </body>
                </html>
